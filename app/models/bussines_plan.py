...
class PostalCodeAddress(db.Model):
    postal_code = db.Column(db.String(36), primary_key=True)


class PivotPostalCodeLocation(db.Model):
...
class SubdistrictsList(db.Model):
