...
Revision ID: 2905106b750d
Revises: 
Create Date: 2023-06-17 08:37:23.046194
...
def upgrade():
    ...
    sa.Column('geolocation', sa.String(length=40), nullable=True),
    ...
    sa.Column('bussiness_bookkeeping_id', sa.String(length=36), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('bussiness_bookkeeping_id')
    )
